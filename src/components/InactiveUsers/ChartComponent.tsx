...
//   const listofcompanies = useAppSelector((state) => state.NewUser.tempcompanieslist);
...
//       PaperProps={{
//         elevation: 10, sx: {
//           width: 230, flexShrink: 100, '& .MuiDrawer-paper': { width: 100, },
//           padding: 3, marginTop: 8, height: "80%", color: "black", backgroundColor: "white", borderRadius: 5,
//         },
//       }}  >
//       <IconButton onClick={() => dispatch(toggleDrawer(false))}>
//         {theme.direction === "rtl" ? (<ChevronLeftIcon />) : (<ChevronRightIcon />)}
//       </IconButton><Divider /><h2> Enrolled Companies</h2>
//       <Divider /><h3>Date: {tempbarclickedDate}</h3> <Divider />
//       <h3>Enrollments: {listofcompanies.length}</h3>
//       <Divider /><List>
//         {listofcompanies?.map((text, index) => (<ListItem >
//           <AddBusinessOutlinedIcon style={{ fill: "#0072ea" }} />
//           <ListItemText primaryTypographyProps={{ paddingLeft: 1, fontSize: "19px", fontFamily: "Playfair", }} primary={text} />
//         </ListItem>))}</List></Drawer></div>)
// }
